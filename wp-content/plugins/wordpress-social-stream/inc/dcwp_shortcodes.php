...
//	print_r($atts);
	...
	$out .= 'if(!jQuery().dcSocialStream) { $.getScript("'.plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.1.5.14.min.js", function(){$("#social-stream-'.$id.'").dcSocialStream(config);}); } else {';
...
//	print_r($stream);
	...
	$out .='<script type="text/javascript">jQuery(document).ready(function($){';
	$out .= 'var config = '.$config.';';
	$out .= 'if(!jQuery().dcSocialStream) { $.getScript("'.plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.wall.1.6.js", function(){}); $.getScript("'.plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.1.5.14.min.js", function(){$("#social-stream-'.$id.'").dcSocialStream(config);}); } else {';
